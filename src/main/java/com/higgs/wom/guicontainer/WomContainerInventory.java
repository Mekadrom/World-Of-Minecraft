...
public class WomContainerInventory extends Container
{
    public WomContainerInventory(InventoryPlayer inventoryPlayer, boolean p_i1819_2_, EntityPlayer p_i1819_3_)
    {
        for(int i = 0; i < 3; ++i)
        {
            for(int j = 0; j < 9; ++j)
