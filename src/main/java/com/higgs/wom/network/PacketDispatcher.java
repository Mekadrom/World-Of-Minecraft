...
public class PacketDispatcher
{
     ...
     */
    private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(HiggsWom.MODID);
    ...
    {
        registerMessage(WomPacketSyncPlayerData.class);
